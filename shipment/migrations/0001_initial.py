    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('furniture', 'Furinture'), ('wood', 'Wood'), ('appliances', 'Appliances'), ('plastic&rubber', 'Plastic and Rubber'), ('multiple commodities', 'Multiple Commodities '), ('food', 'Food'), ('glass', 'Glass')], max_length=200)),
